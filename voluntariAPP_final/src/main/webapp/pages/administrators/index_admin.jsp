                ...
                <table class="table text-nowrap mb-0 align-middle">
                  ...
                  <tr>
                    <td class="border-bottom-0">
                      <h6 class="fw-semibold mb-0">Jassiel</h6>
                    </td>
                    <td class="border-bottom-0">
                      <h6 class="fw-semibold mb-1">12-08-2004</h6>
                    </td>
                    <td class="border-bottom-0">
                      <p class="mb-0 fw-normal">jasss</p>
                    </td>
                    <td class="border-bottom-0">
                      <h6 class="fw-semibold mb-0 fs-4">Mirador</h6>
                    </td>
                    <td class="border-bottom-0">
                      <h6 class="fw-semibold mb-0 fs-4">7772548294</h6>
                    </td>
                    <td class="border-bottom-0">
                      <h6 class="fw-semibold mb-0 fs-4">vidids</h6>
                    </td>
                    <td class="border-bottom-0">
                      <h6 class="fw-semibold mb-0 fs-4">asmams</h6>
                    </td>
                    <td class="border-bottom-0">
