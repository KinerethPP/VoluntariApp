        ...
        <div class="container bg-white rounded shadow">
            ...
            <div class="row align-items-stretch">
                <div class="col bg-white p-5 rounded-end">
                    ...
                    <br>
                    <!-- Register -->
                    <form id="organ-form" action="/organ/save"  class="needs-validation" method="post">
                        <div class="row ">
                            <div class="col-md-6 mb-4">
                                <div class="form-floating">
                                    <input name="bussines_name" type="text" id="bussines_name" class="form-control" placeholder="Empresa" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="form-floating">
                                    <input  name ="municipality" type="text" id="municipality" class="form-control" placeholder="Municipio"
                                        required>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-floating">
                                    <input  name ="postal_code" type="text" id="postal_code" class="form-control" placeholder="Código Postal"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="form-floating">
                                    <input name ="cologne" type="text" id="cologne" class="form-control" placeholder="Colonia" required>
                                    <label for="cologne">Colonia</label>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="form-floating">
                                    <input name="street" type="text" id="street" class="form-control" placeholder="Calle" required>
