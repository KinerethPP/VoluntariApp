            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="/organ/organs" aria-expanded="false">
                <span>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="row pt-1">
                                        <div class="col-6 mb-3">
                                            <h6>Nombre de Oranización</h6>
                                            <p class="text-muted">DIF</p>
                                        </div>
                                        <div class="col-6 mb-3">
                                            <h6>Calle</h6>
                                            <p class="text-muted">Zapote</p>
                                        </div>
                                    </div>
                                    <div class="row pt-1">
                                        <div class="col-6 mb-3">
                                            <h6>Colonia</h6>
                                            <p class="text-muted">Zapata</p>
                                        </div>
                                        <div class="col-6 mb-3">
                                            <h6>Código postal</h6>
                                            <p class="text-muted"> 62039</p>
                                        </div>
                                    </div>
                                    <div class="row pt-1">
                                        <div class="col-6 mb-3">
                                            <h6>Municipio</h6>
                                            <p class="text-muted">Emiliano Zapata</p>
                                        </div>
                                        <div class="col-6 mb-3">
                                            <h6>RFC</h6>
                                    ...
                                    <div class="row pt-1">
                                        <div class="col-6 mb-3">
                                            <h6>Telefono</h6>
                                            <p class="text-muted">7771569632</p>
                                        </div>
                                    </div>
                                    <div class="row pt-1">
                                        <div class="col-6 mb-3">
